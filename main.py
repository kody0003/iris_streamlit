#環境構築でのはまり
#結局VSCodeのターミナルではstreamlit run 成功してない。下記エラーとなる
#  File "C:\anaconda\lib\site-packages\PIL\Image.py", line 100, in <module>
#    from . import _imaging as core
#ImportError: DLL load failed while importing _imaging: 指定されたモジュールが見つかりま せん。
# ため、アナコンダプロンプトのほうでrun してた
# streamlit run "C:\workspace_streamlit\main.py
#参照したリンク
# https://qiita.com/watyanabe164/items/8106e1e3efe62c3c0d80
# https://yondakana.blogspot.com/2018/01/from-pil-import-image.html
